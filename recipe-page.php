...
<body>
    ...
    <div id="contents">
        ...
        <div id="RecipeHead">
            ...
            <div>
                <h1 class="RecipeTitle">Ancho-Orange Chicken with Kale Rice & Roasted Carrots</h1>
                <p class="RecipeDescrip">Weʼre amping up chicken breasts with a glaze of smoky ancho chile paste and fresh orange juice in this recipe. On the side, roasted carrots and lightly creamy, golden raisin-studded rice perfectly accent the sweetness of the glaze.</p>
            </div>
        </div>
        <hr>
        <div id="RecipeInstruct">
            ...
            <ol id="RecipeSteps">
                <li class="stepText">
                    ...
                    <img src="Media/Ancho-Orange_Chicken_with_Kale_Rice_Roasted_Carrots/ancho-chicken-step1.webp" alt="Fluffing rice after cooked in pot." class="StepImg">
                </li>
                <li class="stepText">
                ...
                <li class="stepText">
                    ...
                    <img src="Media/Ancho-Orange_Chicken_with_Kale_Rice_Roasted_Carrots/ancho-chicken-step4.webp" alt="Kale being cooked in pan." class="StepImg">
                </li>
                <li class="stepText">
                    ...
                    <img src="Media/Ancho-Orange_Chicken_with_Kale_Rice_Roasted_Carrots/ancho-chicken-step5.webp" alt="Chicken being cooked with spices." class="StepImg">
                </li>
                <li class="stepText">
